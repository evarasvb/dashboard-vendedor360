...
KEYWORDS = [
    kw.strip() for kw in os.getenv("LICI_KEYWORDS", "").split(",") if kw.strip()
]
...
async def main() -> None:
    ...
    if not KEYWORDS:
        raise SystemExit("LICI_KEYWORDS vacío. Configure palabras clave en .env")
