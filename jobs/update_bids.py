...
def normalize(rows):
    ...
    for r in rows:
        ...
        out.append({
            "id_licitacion": idl, "plataforma": plataforma, "titulo": titulo,
            "fecha_publicacion": fp, "fecha_cierre": fc, "estado": estado,
            "items_total": items_tot, "items_ofertados": items_of, "total_ofertado": total_ofe,
            "motivo_omitida": motivo, "precio_ganador": ganador, "adjudicatario": adj
        })
